			...
			<div class="row">
					...
					<form action="#" method="post">
						<div class="form-group row">
							<div class="col-md-4 ">
								...
								<select class="form-control"
									style="color: rgb(23, 162, 184); border-radius: 10px;">
									<option>지역 전체</option>
									<option>서울</option>
									<option>경기</option>
									<option>인천</option>
							...
							<div class="col-md-4">
								...
								<select class="form-control"
									...
									<option>마스터키 강남점</option>
									<option>미스터리룸 강남점</option>
									<option>비밀의화원</option>
									<option>셜록홈즈</option>
									<option>SEVEN CLUES</option>
									<option>코드이스케이프</option>
									<option>경상</option>
								</select>
							</div>
							<div class="col-md-4">
								...
								<select class="form-control"
									...
									<option>학교의비밀</option>
									<option>거짓말</option>
									<option>사라진백마교도</option>
									<option>JAZZ IN THE RAIN</option>
									<option>체임버</option>
									<option>닥터츄</option>
									<option>광복절특사</option>
									<option>알콜홀릭</option>
									<option>GAME OF MINDS</option>
								</select>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-4">
								...
								<select class="form-control"
									style="color: rgb(23, 162, 184); border-radius: 10px;">
									<option>만날 시간대</option>
									<option>오전10:00~12:00</option>
									<option>오후12:00~14:00</option>
									<option>오후14:00~16:00</option>
									<option>오후16:00~18:00</option>
									<option>오후18:00~20:00</option>
									<option>오후20:00~22:00</option>
									<option>경상</option>
								</select>
							</div>
						...
						<div class="form-group row">
							<div class="col-md-12">
								<textarea style="border-radius: 10px;" class="form-control"
									placeholder="Write your Review." cols="30" rows="12"></textarea>
							</div>
						</div>
						<div class="form-group row">
				...
				<div class="col-lg-4 ml-auto">
					<div class="bg-white p-3 p-md-5">
						<img src="http://www.master-key.co.kr/upload/room/175_img1.png"
